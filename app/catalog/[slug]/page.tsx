...
import { Package, ChevronRight, Users, Star, Zap } from "lucide-react";
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-3">
              {features.map((feature) => (
                <span key={feature} className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-sm text-white backdrop-blur-sm">
          ...
          <MaxWidthWrapper>
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
                Discover the most frequently analyzed npm packages using {data.name}. 
                Get comprehensive insights and make informed decisions.
              </p>
            </div>

                  ...
                  <CardContent className="p-4">
                    <div className="flex justify-between items-center mb-4">
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">v18.2.0</div>
                      </div>
      ...
      >
        {isLeft ? (
          <>
            ...
            <p className="text-muted-foreground mb-4 animate__animated animate__fadeInLeft" style={{ animationDelay: "0.1s" }}>
              {description}
            </p>
            <div className="flex justify-end">
              <ul className="text-muted-foreground text-sm space-y-2 animate__animated animate__fadeInLeft" style={{ animationDelay: "0.2s" }}>
          ...
          <>
            ...
            <p className="text-muted-foreground mb-4 animate__animated animate__fadeInRight" style={{ animationDelay: "0.1s" }}>
              {description}
            </p>
            <ul className="text-muted-foreground text-sm space-y-2 animate__animated animate__fadeInRight" style={{ animationDelay: "0.2s" }}>
              {features.map((feature, index) => (
...
function SearchResult({ name, downloads }: { name: string; downloads: string }) {
  return (
  ...
  return (
    <div className="space-y-1 mb-3">
      ...
      <div className="flex justify-between items-center text-xs">
        ...
        <span className="text-muted-foreground">{progress === 100 ? "Complete" : `${progress}%`}</span>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="h-20 flex items-end justify-between space-x-2">
      <div className="flex-1">
        ...
        <div className="text-xs text-center mt-1 text-muted-foreground">React</div>
      </div>
      <div className="flex-1">
        <div className="bg-primary/60 h-12" />
        <div className="text-xs text-center mt-1 text-muted-foreground">Preact</div>
      </div>
      <div className="flex-1">
        <div className="bg-primary/40 h-8" />
        <div className="text-xs text-center mt-1 text-muted-foreground">Solid</div>
      </div>
    </div>
  )
} 
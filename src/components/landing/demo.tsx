      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row">
                ...
                <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
                  <Card className="bg-muted/50">
                    <CardContent className="p-4">
                      <p className="mb-1 text-xs text-muted-foreground">Weekly Downloads</p>
                  ...
                  <Card className="bg-muted/50">
                    <CardContent className="p-4">
                      <p className="mb-1 text-xs text-muted-foreground">Bundle Size</p>
                      <p className="text-xl font-bold">42.7 kB</p>
                      <p className="mt-1 text-xs text-muted-foreground">gzipped</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-muted/50">
                    <CardContent className="p-4">
                      ...
                      <p className="mt-1 text-xs text-green-600">All up to date</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-muted/50">
                    <CardContent className="p-4">
          ...
          <div className="lg:w-1/2 animate__animated animate__fadeInRight">
            ...
            <div className="mt-8">
              <Button size="lg" variant="secondary" className="bg-super-primary text-primary hover:bg-super-primary/90">
                Try the Dashboard
              </Button>
            </div>
          </div>

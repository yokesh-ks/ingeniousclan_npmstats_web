...
export function CTA() {
  return (
    <section id="cta" className="relative py-20 bg-gradient-to-b from-[#000080] to-[#000055]">
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-12">
              ...
              <p className="text-gray-600 mb-8">
                Get instant access to comprehensive npm package insights. No credit card required.
              </p>
              ...
              <div className="mt-6 text-center text-sm text-gray-500">
                ...
                <a href="#" className="text-[#000080] font-medium hover:underline">
                  Sign in
                </a>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-8 md:p-12 flex flex-col">
              ...
              <div className="mt-auto pt-6 border-t border-gray-200">
                ...
                <div className="flex justify-center mt-4 space-x-6 opacity-70">
                  <div className="text-gray-600 font-mono text-sm">Microsoft</div>
        ...
        >
          <h3 className="text-2xl font-bold mb-4">Join Thousands of Satisfied Developers</h3>
          <p className="text-xl text-gray-200 mb-6 max-w-3xl mx-auto">
            From solo developers to enterprise teams, NpmStats is the trusted solution for making
            informed package decisions.
          </p>
          <div className="flex flex-wrap justify-center items-center space-x-4 space-y-4 sm:space-y-0">
            <div className="flex items-center">
              ...
              <div className="ml-4 text-gray-200 text-sm">5,200+ users worldwide</div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-2 text-gray-200 text-sm">4.9/5 from 300+ reviews</div>
            </div>
          </div>
        </div>
      </div>
...
const benefits = [
  ...
  },
  {
    ...
    description: "Identify potential vulnerabilities before they impact your apps.",
  },
  {
